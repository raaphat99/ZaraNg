...
export class HeaderComponent  {
  ...
  selectitem: Category[] = [];
  constructor(private authService : AuthService,public categoryService:CategoryService ,private eRef: ElementRef,private router: Router,private cartService: CartService) {
